...
**"Simple" Option Y (THIS README)**: Similar to [Option X](./README_OPTION_X.md)
...
Click the system tray icon and choose:
...
- **Change default 'Startup Disk'**: Select if you want to use Linux or macOS as the default 'Startup Disk'
...
- **Always Changes 'Startup Disk' Setting**: Shutting down or restarting the computer
  ...
  Change the default 'Startup Disk' back to Linux by e.g. using the submenu, or by using
  ["Restart in Linux"](https://github.com/rxhfcy/Asahi-Restart-Helper--macOS-version) on macOS.
...
e.g. using ["Restart in Linux"](https://github.com/rxhfcy/Asahi-Restart-Helper--macOS-version),
using this application's submenu,
or from macOS System Settings / Startup Disk.
